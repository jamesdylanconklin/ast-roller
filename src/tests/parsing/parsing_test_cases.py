...
SEQUENCE_EXPRESSION_CASES = [generate_sequence_expression_case([LIST_EXPRESSION_CASES[x], LIST_EXPRESSION_CASES[y]]) for x in range(3) for y in range(3, len(LIST_EXPRESSION_CASES))]
